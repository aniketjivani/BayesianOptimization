...
class UtilityFunction(object):
    ...
    def __init__(self, kind, kappa, xi, kappa_decay=1, kappa_decay_delay=0, t=0, epsFactor=2):
        ...
        if kind not in ['ucb', 'ei', 'poi', 'eff']:
            err = "The utility function " \
                  "{} has not been implemented, " \
                  "please choose one of ucb, ei, poi or eff.".format(kind)
        ...
        def utility(self, x, gp, y_max):
            ...
            if self.kind == 'eff':
                return self._eff(x, gp, self.t, self.epsFactor)
